...
export function Projects() {
  ...
  return (
    <section id="referenzen" className="py-24 md:py-32 bg-background">
        ...
        <div className="mt-16 grid md:grid-cols-2 gap-8">
          {t.projects.items.map((project, index) => (
            ...
            >
              ...
              />
              {/* Overlay */}
              <div className="absolute inset-0 bg-linear-to-t from-foreground/80 via-foreground/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              ...
              <div className="md:hidden absolute bottom-0 left-0 right-0 p-6 bg-linear-to-t from-foreground/90 to-transparent">
